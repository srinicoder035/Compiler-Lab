...
%token IF ELSE WHILE RETURN VOID INT FLOAT FOR
...
%left PLUS MINUS
%left STAR SLASH
%type<ast> atree program external_declaration var_declaration init_declarator_list fun_declaration params_list compound_stmt declarator params block_item_list block_item factor call term additive_expression simple_expression unary_expression postfix_expression assignment_expression return_stmt while_stmt if_stmt for_stmt expression statement args expression_stmt 
...
return_stmt
    ...
    ;
for_stmt
    : FOR LPAREN expression_stmt expression_stmt RPAREN statement {$$ = newnode(yylineno,"for_stmt", none, none, none,  2, $4, $6);}
    | FOR LPAREN expression_stmt expression_stmt expression RPAREN statement {$$ = newnode(yylineno,"for_stmt", none, none, none,  2, $4, $7);}
    ;
